...
class Category(models.Model):
    id=models.AutoField(primary_key=True,blank=False,null=False,verbose_name="ID")
...
class Order(models.Model):
    id=models.AutoField(primary_key=True,blank=False,null=False,verbose_name="ID")
    items=models.CharField(blank=False,null=False,verbose_name="Item",max_length=2000)
    cart=models.IntegerField(blank=False,null=False,verbose_name="Cart")
